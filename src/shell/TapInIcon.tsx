...
export default function TapInIcon({ className }: { className?: string }) {
  const gold = `ti-gold-${useId().replace(/:/g, "")}`;
  return (
    <svg className={className} viewBox="0 0 84 85" aria-hidden="true" focusable="false">
      ...
      <path className="ti-dot" d="M69.3056 29.2633C77.3245 29.2633 83.8252 22.7125 83.8252 14.6317C83.8252 6.55082 77.3245 0 69.3056 0C61.2867 0 54.7861 6.55082 54.7861 14.6317C54.7861 22.7125 61.2867 29.2633 69.3056 29.2633Z" fill={`url(#${gold})`} />
